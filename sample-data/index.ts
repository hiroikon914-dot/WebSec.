import type { NewsItem, Routine, ScheduleItem, Task } from "@/types/domain";
...
export const sampleSchedule: ScheduleItem[] = [
  { id: "s1", title: "朝ブリーフ確認",    startTime: "05:30", endTime: "06:00", source: "manual",    category: "プライベート" },
  { id: "s2", title: "PC候補を調べる",   startTime: "14:00", endTime: "15:00", source: "generated", category: "プライベート" },
  { id: "s3", title: "芝作業準備（砂手配）", startTime: "15:30", endTime: "16:30", source: "generated", category: "プライベート" },
  { id: "s4", title: "車準備の段取り",   startTime: "21:10", endTime: "21:40", source: "manual",    category: "プライベート" }
];
